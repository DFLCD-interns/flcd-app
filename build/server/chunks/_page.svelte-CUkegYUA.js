...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<section class="bg-gray-200 min-h-screen flex items-center justify-center p-5"><div class="bg-gray-100 w-full flex rounded-xl max-w-4xl drop-shadow-xl"><div class="w-full ps-3 pe-3 pb-2"><div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 w-full"><div class="sm:w-full sm:mx-auto w-full relative">${validate_component(Button, "Button").$$render(
      $$result,
      {
        color: "alternative",
        class: "!p-2 absolute top-0 left-0",
      ...
      {},
      {}
    )}</div></div> <div>${validate_component(Label, "Label").$$render($$result, { for: "phone", class: "mb-2" }, {}, {
      default: () => {
        return `Phone number`;
      }
    })} ${validate_component(Input, "Input").$$render(
    ...
    })}</div></div> <div class="sm:w-1/2 w-full mt-3 mb-3 space-y-4 sm:pl-1.5"><div>${validate_component(Label, "Label").$$render($$result, { for: "email", class: "mb-2" }, {}, {
      default: () => {
...
//# sourceMappingURL=_page.svelte-CUkegYUA.js.map
