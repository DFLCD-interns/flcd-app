import { c as create_ssr_component, v as validate_component, d as each, e as escape, q as compute_rest_props, p as getContext, b as add_attribute, g as spread, h as escape_object, t as escape_attribute_value, u as compute_slots } from './ssr-D-0G9OQq.js';
...
const PrinterSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$restProps = compute_rest_props($$props, ["size", "role", "color", "withEvents", "title", "desc", "ariaLabel"]);
  const ctx = getContext("iconCtx") ?? {};
  const sizes = {
    xs: "w-3 h-3",
  ...
  let ariaDescribedby = `${title.id || ""} ${desc.id || ""}`;
  let hasDescription = false;
  let { ariaLabel = "printer solid" } = $$props;
  if ($$props.size === void 0 && $$bindings.size && size !== void 0) $$bindings.size(size);
  if ($$props.role === void 0 && $$bindings.role && role !== void 0) $$bindings.role(role);
  if ($$props.color === void 0 && $$bindings.color && color !== void 0) $$bindings.color(color);
  if ($$props.withEvents === void 0 && $$bindings.withEvents && withEvents !== void 0) $$bindings.withEvents(withEvents);
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M8 3a2 2 0 0 0-2 2v3h12V5a2 2 0 0 0-2-2H8Zm-3 7a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h1v-4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v4h1a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2H5Zm4 11a1 1 0 0 1-1-1v-4h8v4a1 1 0 0 1-1 1H9Z" clip-rule="evenodd"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M8 3a2 2 0 0 0-2 2v3h12V5a2 2 0 0 0-2-2H8Zm-3 7a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h1v-4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v4h1a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2H5Zm4 11a1 1 0 0 1-1-1v-4h8v4a1 1 0 0 1-1 1H9Z" clip-rule="evenodd"></path></svg>`} `;
});
const css = {
    ...
    $$rendered = `<div class="px-10 py-10"><div class="flex items-center gap-4 mb-5">${validate_component(Button, "Button").$$render(
      ...
      default: () => {
        return `${validate_component(TabItem, "TabItem").$$render($$result, { open: true }, {}, {
          ...
          title: () => {
            return `<span slot="title" class="flex gap-2">${validate_component(PrinterSolid, "PrinterSolid").$$render($$result, {}, {}, {})}Printing Only</span>`;
          },
          default: () => {
            return `${validate_component(Card, "Card").$$render($$result, { class: "max-w-full" }, {}, {
              default: () => {
                return `<form class="flex flex-col space-y-6" action="?/submitPrintingRequest" method="post"><div data-svelte-h="svelte-abqmvq"><h3 class="text-xl font-medium text-gray-900 dark:text-white">Printing Only</h3> <h5 class="text-sm mt-1">available only for FLCD students</h5></div> <hr> ${validate_component(Label, "Label").$$render($$result, { class: "space-y-2" }, {}, {
                  default: () => {
                    return `<span data-svelte-h="svelte-b6d4hk">Purpose</span> ${validate_component(Input, "Input").$$render(
                      $$result,
                      {
                        disabled: !isFLCD,
                        type: "text",
                ...
                })} <div class="grid gap-6 mb-6 md:grid-cols-2">${validate_component(Label, "Label").$$render($$result, { class: "space-y-2" }, {}, {
                  default: () => {
                    return `<span data-svelte-h="svelte-v7lnps">Printing Date &amp; Time</span> ${validate_component(Input, "Input").$$render(
                      $$result,
                      {
                        disabled: !isFLCD,
                        type: "datetime-local",
...
//# sourceMappingURL=_page.svelte--abDbckM.js.map
