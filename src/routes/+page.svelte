        ...
        <div class="sm:w-1/2 w-full p-6 flex flex-col justify-center">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 class="mt-5 text-center text-3xl font-bold leading-9 tracking-tight text-gray-900">
                    Sign in to 
                    <!-- <svg width="368" height="73" viewBox="0 0 368 73" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline align-middle h-14 w-auto mt-[-0.45rem]"> -->
                    <svg class="responsive-svg inline align-middle mt-[-0.45rem]" viewBox="0 0 368 73" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style lang="postcss">
    ...
    .responsive-svg {
      width: 78%; /* Adjust width to be a percentage of the container */
      height: auto;
    }

    @media (max-width: 480px) {
        .responsive-svg {
            width: 100%; /* Even bigger percentage for very small screens */
        }
    }
  </style>