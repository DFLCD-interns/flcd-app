<script>
    ...
    let requestInfo = data.reqdetails[0];

    let request_type = "";

    if (data.type == "equipment_requests"){
        request_type = "Equipment Requests"
    }
    else if (data.type == "venue_requests"){
