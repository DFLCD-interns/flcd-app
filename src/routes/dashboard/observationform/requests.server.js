...
export async function createObservationRequestServer(session_id, staff_assistant_id, purpose, timeslots) {
    ...
    //createBaseRequestDB(instructor_id, staff_assistant_id, purpose, office, company, max_approval_layer, requester_id, completion_time)
    
    // staff_assistant_id, purpose, max_approval_layer, requester_id, completion_time
