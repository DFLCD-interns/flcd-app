    ...
    <div class="sm:w-1/3 w-full mb-2 sm:mb-0 px-3 flex"> <!-- Add flex here -->
      <Card class="relative w-full max-w-full h-full"> <!-- Add h-full here -->
        ...
        <div class="flex sm:flex-row flex-col sm:justify-end relative">
          ...
          <GradientButton color="green" shadow href="/dashboard/equipment-requests" class="sm:mt-16 mt-0 sm:mb-4 ml-auto w-fit align-self-end">
    ...
    <div class="sm:w-1/3 w-full mb-2 sm:mb-0 px-3 flex"> <!-- Add flex here -->
      <Card class="relative w-full max-w-full h-full"> <!-- Add h-full here -->
        ...
        <div class="flex sm:flex-row flex-col sm:justify-end relative">
          ...
          <GradientButton color="green" shadow href="/dashboard/venue-requests" class="sm:mt-16 mt-0 sm:mb-4 ml-auto w-fit align-self-end">
