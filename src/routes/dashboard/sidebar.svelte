...
<div>
    ...
    <ul class="space-y-2 tracking-wide mt-8">
      ...
      <li>
        ...
        <li>
            <a href="/dashboard/databases" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-gradient-to-r hover:from-green-600 hover:to-lime-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
