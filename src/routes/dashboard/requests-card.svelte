...
<Card class="w-full max-w-full" href="#">
  ...
  <div class="flex items-center justify-between">
    <div class="mb-2">
      ...
      <Badge class="mt-2" large border color='{info.status === 'Approved' ? statusColors.approved : info.status === 'Declined' ? statusColors.declined : statusColors.pending}'> {info.status} </Badge>
    </div>
